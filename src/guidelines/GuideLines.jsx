...
const GuideLines = () => {
  return (
    <div className='guidelines'>
        ...
        <p>ICTEST 2026 aims to bring together researchers, academicians, and industry professionals from around the globe to share their latest research findings, exchange ideas, and discuss emerging trends in engineering systems and technologies. The conference will cover a wide range of topics related to engineering, including but not limited to</p>
        <ConfernceTrack />
        <PaperSharing />
    </div>
  )
