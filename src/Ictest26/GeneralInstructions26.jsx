...
import '../Ictest25/GeneralInstructions.css';

const GeneralInstructions26 = () => {
    return (
        <div className="instructions-container">
            ...
            <div className="instruction-section">
                ...
                <ul>
                    <li>Revise your paper as per reviewers' comments, available at <a href="https://cmt3.research.microsoft.com/ICTEST2026">ICTEST-2026 CMT</a>.</li>
            ...
            <div className="instruction-section">
                ...
                <p><strong>File Naming Convention:</strong> PaperID_ictest26.pdf</p>
...
export default GeneralInstructions26;
